...
int adjFun(const real_t** arg, real_t** res, int* iw, real_t* w, int mem) {
  ...
  a4=(a5*a4);
  real_t a8=sin(a3);
  real_t a9=9.8100000000000005e+00;
  a8=(a9*a8);
  a4=(a4+a8);
  a8=2.;
  real_t a10=arg[0] ? arg[0][3] : 0;
  a10=(a8*a10);
  real_t a11=arg[0] ? arg[0][7] : 0;
  real_t a12=(a10*a11);
  a4=(a4+a12);
  a4=(a4/a1);
  a4=(a4/a1);
